    ...
    <DashboardLayout>
      <div className="space-y-8">
        ...
        <div className="relative overflow-hidden rounded-2xl bg-gradient-to-br from-teal-50 via-white to-purple-50 p-8 shadow-sm">
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center lg:justify-between">
            <div>
              ...
              <p className="text-muted-foreground mt-2 text-lg">Explore and manage your high-quality AI prompts.</p>
            </div>
            <div className="flex items-center space-x-4 mt-4 lg:mt-0">
              <Badge variant="secondary" className="bg-gradient-to-r from-blue-100 to-blue-200 text-primary px-4 py-1.5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-teal-500 to-teal-600 text-primary-foreground">
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-purple-500 to-purple-600 text-primary-foreground">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-orange-500 to-orange-600 text-primary-foreground">
            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
            ...
            <Card className="border-0 shadow-lg">
              <CardHeader className="bg-gradient-to-r from-teal-50 to-purple-50 rounded-t-lg">
                <CardTitle className="flex items-center space-x-2">
                  ...
                  <Badge variant="secondary" className="ml-auto bg-primary/10 text-teal-700">
                    <Sparkles className="w-3 h-3 mr-1" />
                    Fresh
                  </Badge>
                </CardTitle>
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {latestPrompts.map((prompt) => (
                    <div key={prompt.id} className="group relative flex items-center justify-between p-4 border border rounded-xl hover:border-primary hover:shadow-md transition-all duration-300 bg-card">
                      {prompt.isNew && (
                        <div className="absolute -top-2 -left-2">
                          <Badge className="bg-red-500 text-primary-foreground text-xs px-2 py-0.5">NEW</Badge>
                        </div>
                      )}
                      <div className="flex-1">
                        <h4 className="font-semibold text-base text-foreground group-hover:text-teal-700 transition-colors">{prompt.title}</h4>
                ...
                <div className="mt-6">
                  <Link href="/prompts">
                    <Button className="w-full bg-gradient-to-r from-teal-600 to-teal-700 hover:from-teal-700 hover:to-teal-800 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300">
                      Browse All Prompts
              ...
              <CardContent className="p-6">
                <div className="space-y-4">
                  {popularTools.map((tool, index) => (
                    <div key={index} className="group p-4 border border rounded-xl hover:border-primary hover:shadow-md transition-all duration-300 bg-card">
                      <div className="flex items-center justify-between mb-3">
                        <div className="flex items-center gap-3">
                          <div className={`w-10 h-10 ${tool.color} rounded-lg flex items-center justify-center text-primary-foreground font-bold shadow-md`}>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-gray-50 to-gray-100">
              ...
              <CardContent className="space-y-3">
                <Link href="/prompts/create">
                  <Button variant="outline" className="w-full justify-start bg-card hover:bg-teal-50 hover:border-teal-300 hover:text-teal-700 transition-all duration-300 group">
                ...
                <Link href="/tools">
                  <Button variant="outline" className="w-full justify-start bg-card hover:bg-purple-50 hover:border-purple-300 hover:text-purple-700 transition-all duration-300 group">
