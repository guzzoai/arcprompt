-- Migration for Prompt Vault Schema Updates
...
-- Update existing difficulty_level values to match new format
UPDATE public.prompts SET difficulty_level = 'Beginner' WHERE difficulty_level = 'beginner';
UPDATE public.prompts SET difficulty_level = 'Intermediate' WHERE difficulty_level = 'intermediate';
UPDATE public.prompts SET difficulty_level = 'Advanced' WHERE difficulty_level = 'advanced';
UPDATE public.prompts SET difficulty_level = 'Expert' WHERE difficulty_level = 'expert';

-- Update difficulty_level to match markdown format
ALTER TABLE public.prompts ALTER COLUMN difficulty_level TYPE TEXT;
ALTER TABLE public.prompts DROP CONSTRAINT IF EXISTS prompts_difficulty_level_check;
ALTER TABLE public.prompts ADD CONSTRAINT prompts_difficulty_level_check CHECK (difficulty_level IN ('Beginner', 'Intermediate', 'Advanced', 'Expert'));
